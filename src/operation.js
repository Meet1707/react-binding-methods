    ...
    perOperation = op => {
      ...
      switch (op) {
        case "+":
          ...
          this.setState({ ans: Number(vl1) + Number(this.state.vl2) }, () =>  this.props.showans(this.state.ans));
      ...
      return (
        <div>
          ...
          <div className="row">
            ...
            <div className="col">
              <button className="btn btn-dark" onClick={this.props.clearData}>Clear</button>
            </div>
          </div>
        </div>
      );
